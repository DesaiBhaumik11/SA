...
class OrderPlacedScreenState extends State<OrderPlacedScreen>
  ...
  Widget TabBody(GetOrderByIdResponseModel model,
    ...
    return Container(
      child: TabBarView(
        children: <Widget>[
          Summary(model, controller, statusManagements, widget.IsFromPayment),
          OrderItems(model),
        ],
        controller: controller,
      ),
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          if (apiResponseModel.statusCode == 200) {
            GetOrderByIdResponseModel responseModel =
                GetOrderByIdResponseModel.fromJson(apiResponseModel.Result);
...
//            responseModelZ.toString();
            List<StatusManagement> statusManagements =
                StatusManagement.getStatusMangement(
                    responseModel.status,
                    responseModel.shippingOrder.shippingStatus,
                    responseModel.paymentStatus);
...
class Summary extends StatefulWidget {
  ...
  Summary(this.model, this.controller, this.statusManagements, this.IsFromPayment);
...
class _SummaryState extends State<Summary> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    if ((status == EnumOrderStatus.Ordered ||
            status == EnumOrderStatus.Confirmed) &&
        shippingStatus == EnumShippingStatus.Pending) {
  ...
  @override
  Widget build(BuildContext context) {
    String day_ = widget.model.shippingOrder.shippingSchedule != null &&
            widget.model.shippingOrder.shippingSchedule.date != null
        ? widget.model.shippingOrder.shippingSchedule.date
        : "";
    String day = day_.isNotEmpty
        ? DateFormat(EnumDateFormat.app)
            .format(widget.model.shippingOrder.shippingSchedule.dateTime)
        : "";
    return ListView(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Expanded(
                          child: Text(
                              widget.model.shippingOrder.shippingSchedule
                                      .timeFrom +
                                  " - " +
                                  widget.model.shippingOrder.shippingSchedule
                                      .timeTo,
                    ...
                    SizedBox(
                      height: 100,
                      child: widget.statusManagements.length <= 0
                          ? Container()
                          : s.CustomStepper(
                              steps: statusStep(widget.statusManagements),
//                       [
...
//                     ],
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      widget.model.shippingOrder.name,
                      style: TextStyle(
                        fontWeight: FontWeight.w500,
                        fontSize: 18,
                      ),
                    ...
                    Text(
                      widget.model.shippingOrder.addressLine1 +
                          widget.model.shippingOrder.addressLine2 +
                          widget.model.shippingOrder.city +
                          " , " +
                          widget.model.shippingOrder.state +
                          " , " +
                          widget.model.shippingOrder.country +
                          " , " +
                          widget.model.shippingOrder.pin,
                      style: address,
                    ),
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          widget.model.itemCount.toString() + ' Items',
                          style: text,
                        ),
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          widget.model.shippingCharges.toString(),
                          style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                'Disclaimer:Please check the product at the time of delivery.',
                style: TextStyle(
  ...
  List<s.Step> statusStep(List<StatusManagement> list) {
    ...
    for (int i = 0; i < list.length; i++) {
      ...
      steps.add(new s.Step(
          ...
          state: statusManagement.state,
          isActive: statusManagement.isActive));
    }
    return steps;
  }
  ...
  void apiOrderCancellationRequestById(String transactionId) {
    ...
    ApiCall()
        .setContext(context)
        .orderCancellationRequestById(transactionId)
      ...
      if (apiResponseModel.statusCode == 200) {
        ...
        Navigator.push(
            context,
            EnterExitRoute(
                enterPage: OrderPlacedScreen(responseModel.id, widget.IsFromPayment)));
      } else if (apiResponseModel.statusCode == 401) {
