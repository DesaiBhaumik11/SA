  ...
  Widget build(BuildContext context) {
    ...
    if (!myCartModal.loaded) {
      ...
      if (allCals) {
        ...
        cartSize = myCartModal.result == null
            ? 0
            : myCartModal.result.cartItemViewModels.length;
      }
    }
...
//    }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                bestSelling.loaded
                    ? horizontalList(
                        context, "Best Selling Items", bestSelling.result)
                    : Center(
                        child: Padding(
                ...
                vegitosExclusive.loaded
                    ? horizontalList(
                        context, "Vegeto's Exclusive", vegitosExclusive.result)
                    : Container(),
                recommendedProducts.loaded
                    ? horizontalList(context, "Recommended for you",
                ...
                Row(
                  children: <Widget>[
                    Text(
                      ...
                      style:
                          TextStyle(fontSize: 15.0, fontFamily: 'GoogleSans'),
                ...
                Row(
                  children: <Widget>[
                    Text(
                      'No Location Found',
                      style:
                          TextStyle(fontSize: 20.0, fontFamily: 'GoogleSans'),
                    ),
                    Icon(
                      Icons.error,
                      color: Colors.red,
  ...
  Widget horizontalList(
      BuildContext context, String s, List<bst.Result> products) {
    return Stack(
      children: <Widget>[
        Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      margin: EdgeInsets.fromLTRB(25.0, 0.0, 0.0, 0.0),
                      child: Image.asset(
                        'assets/customer_support_menu.png',
                        height: 20.0,
                        width: 20.0,
                      ),
                    ),
  ...
  void logoutApi([BuildContext context]) {
    ...
    NetworkUtils.getRequest(endPoint: Constant.Logout).then((res) {
      ...
      getJwtToken(uuid).then((token) {
        ...
        DashboardScreen.appFirstModal.appFirstRun(token,
            [Navigator.pushReplacementNamed(context, Const.loginScreen)]);
      });
    });
  }
